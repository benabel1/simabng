...
public class CardOptionTargetOtherPlayerAndCardInFrontOrHand extends CardOption {
    private GamePlayer target;
    private ZONE zone;
    private GameCard stealCard;

    public CardOptionTargetOtherPlayerAndCardInFrontOrHand(GameCard card, GamePlayer player, GamePlayer target, ZONE zone, GameCard stealCard) {
        super(card, player);
        this.target = target;
        this.zone = zone;
        this.stealCard = card;
